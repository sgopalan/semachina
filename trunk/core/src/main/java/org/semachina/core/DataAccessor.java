 ...
 *
 */
public abstract class DataAccessor<L> implements RDFDatatype, As {

	private String _typeURI;
	
	private Class<L> _javaClass;
	
	public DataAccessor(String typeURI, Class<L> javaClass) {
		_typeURI = typeURI;
    ...
    */
	...
	abstract protected L parseLexicalForm(String lexicalForm) throws Exception;

    abstract protected String toLexicalForm(L cast);
}