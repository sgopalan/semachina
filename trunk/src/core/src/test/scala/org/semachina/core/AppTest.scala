...
class AppTest {
  ...
  //    ontClass.list {println}
  //
  //    //for some reason m.getIndividual("http://dcgs.enterprise.spfg/20080324.owl#DESPortfolio")  doesn't work
  //    var indiv: Individual = "des:DESPortfolio"
  //    indiv.listProperties() {/? => println("P: " + /?)}
  //
  ////    indiv += ("des:hasDouble", "2" )
  //
  ////    var example = "des:hasDouble".DATA -> #:("2", "xsd:double")
  //
  //    //val double = indiv[Double]("des:hasDouble".DATA)
  //
  ...
  //    indiv.listProperties() {/? => println("P: " + /?)}
  //
  //    //indiv( "bah:narrowerLayer".OBJ* ) { rdfNode => println("RDFNode: " + rdfNode)}
  //
  //
  //
  //    //println(indiv -= ("bah:narrowerLayer", common))
  ...
  //    //println("apply: " + indiv("rdfs:label".PROP))
  //
  //
