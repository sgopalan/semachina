 ...
 * language represents natural language identifiers to defined by [RFC 1766].
 * The value space of language is the set of all strings that are valid language identifiers 
 * to defined in the language identification section of [XML 1.0 (Second Edition)].
 ...
 * @see org.apache.axis.encoding.Language (Axis 1.4)
 */
